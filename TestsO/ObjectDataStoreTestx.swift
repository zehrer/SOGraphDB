...
internal class TestDataClass : Coding {
...
class ObjectDataStoreTests: XCTestCase {
    ...
    func test1StoreFile() {
        ...
        var objectStore = ObjectDataStore<TestDataClass>(url: url)
    ...
    func test2WriteData() {
        ...
        var dataClass = TestDataClass(num:42)
        ...
        //ObjectDataStore = nil
        objectStore = ObjectDataStore<TestDataClass>(url: url)
